        ...
        <div className="grid md:grid-cols-2 gap-1 items-center">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-white p-1 rounded-lg shadow-sm col-span-1">
              <Image
                src="/cement5.jpg?height=80&width=300"
            ...
            <div className="bg-white p-1 rounded-lg shadow-sm">
              <Image
                src="/cement2.png?height=60&width=120"
            ...
            <div className="bg-white p-1 rounded-lg shadow-sm col-span-2">
              <Image
                src="/cement4.jpg?height=60&width=240"
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8">And we are Local. Just a call away from you</p>
