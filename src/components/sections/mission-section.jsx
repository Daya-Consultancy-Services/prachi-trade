                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                        <h2 className="text-2xl sm:text-3xl font-bold mb-4 leading-snug">
                            Our mission is to{" "}
                            <span className="text-orange-500">Build your dream stronger</span>
                        </h2>

                        <p className="text-gray-600 mb-4 text-sm sm:text-base">
                            Make your foundation strong with your trusted partner and authorized
                            dealer of India's top brands in construction materials like UltraTech,
                            Dalmia, Jindal, TATA Tiscon, Nuvoco and more
                        </p>
