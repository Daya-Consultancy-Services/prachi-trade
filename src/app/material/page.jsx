            ...
            <section className="relative h-96 flex items-center justify-center overflow-hidden">
                ...
                <div className="relative text-white max-w-5xl text-center px-4">
                    ...
                    <p className="text-lg md:text-sm opacity-90">
                        When building your ideal home, we are here as the best cement dealer in
                        India to save your building. Our motto is getting the tough stuff and
                ...
                <div className="w-full bg-white py-10 px-4 flex flex-col md:flex-row items-center justify-center gap-8">
                    <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div>
                            ...
                            <p className="mb-3">
                                India is the largest producer of gray cement, ready mix material,
                                and white cement. UltraTech Cement plays a vital role in
                                today&apos;s tough India. As a brand, it inspires many real estate
                                and engineering professionals to create a more conceptual brand.
                            </p>
                            <p>
                                UltraTech has a combined capacity of 116.8 million tonnes of gray
                                cement per annum (MTPA). UltraTech has a network of over one lakh
                                channel partners across the country and has a market share of over
                                80% across India. You can connect with UltraTech by searching for
                                UltraTech Cement dealers near me.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full bg-orange-100 py-10 px-4 flex flex-col md:flex-row items-center justify-center gap-8">
                    <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div>
                            ...
                            <p className="mb-3">
                                A leading construction company in India, Nuvoco is one of the
                                leading cement manufacturers in India and a well-known player in the
                                East, offering high-quality cement products. If you are looking for
                                a building material company, you are in the right place; you can
                                also search Nuvoco Cement dealers near me.
                            </p>
                ...
                <div className="w-full bg-white py-10 px-4 flex flex-col md:flex-row items-center justify-center gap-8">
                    <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div>
                            ...
                            <p className="mb-3">
                                The organization works with a manufacturing limit of 30.75 MnT per
                                annum (MTPA) across thirteen concrete plants and crushing units
                                across nine states. With north of 20,000 sellers and sub-vendors,
                                the organization benefits over 22 states and is among the leading
                                players in each locale where it is available. To find the cement
                                dealer nearest to you now, search Dalmia Cement dealers near me.
                            </p>
                            <ul className="list-disc pl-5 space-y-1">
