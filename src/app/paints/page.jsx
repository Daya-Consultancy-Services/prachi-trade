...
export default function PaintsPage() {
    ...
    useEffect(() => {
        Promise.all([
            ...
            const paintsCategory = categories.find((cat) =>
            ...
            const paintsSubcategories = subcategories.filter(
                (sub) => sub.category === paintsCategory._id
            );
            const allProducts = paintsSubcategories.flatMap((sub) => sub.products || []);
