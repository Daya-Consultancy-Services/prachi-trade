    ...
    <section className="py-12 bg-white text-center">
      ...
      <div className="flex justify-center space-x-4 overflow-x-auto p-4">
        ...
        <div className="bg-white border rounded-xl shadow-md   w-72 min-w-[270px] relative">
          <img src="/angel.png" alt="Steel" className="h-50 w-full mx-auto mb-5" />
          <h3 className="text-xl font-bold mb-5">Angel</h3>
          ...
          <button className="bg-orange-600 text-white py-2 px-4 rounded-full font-bold mb-5">
            <Link href="erection" className="block px-4 py-2">
            VIEW PRODUCTS
            </Link>
          </button>
        </div>
        ...
        {/* pipe Card */}
        <div className="bg-white border rounded-xl shadow-md  w-72 min-w-[270px] relative">
          <img src="/pipe.png" alt="Cement" className="h-50 w-full mx-auto mb-5" />
          <h3 className="text-xl font-bold mb-5">Pipe</h3>
          <p className="text-sm mb-5">
        ...
        {/* flat Card */}
        <div className="bg-white border rounded-xl shadow-md  w-72 min-w-[270px] relative">
          <img src="/flat.png" alt="RMC" className="h-50 w-full mx-auto mb-5" />
          <h3 className="text-xl font-bold mb-5">Flat</h3>
          <p className="text-sm mb-5">
        ...
        {/* Roofing Sheets Card */}
        <div className="bg-white border rounded-xl shadow-md  w-72 min-w-[270px] relative">
          <img src="/roofing sheet1.png" alt="Roofing Sheets" className="h-50 w-full mx-auto mb-5" />
