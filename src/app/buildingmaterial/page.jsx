...
export default function buildingmaterial() {
    ...
    <section className="py-12 bg-white text-center">
      ...
      <div className="flex justify-center space-x-4 overflow-x-auto p-4">
        ...
        <div className="bg-white border rounded-xl shadow-md p-2 w-72 min-w-[270px] relative">
          <img src="/steel2.png" alt="Steel"  className="w-full h-60 object-cover mb-4"  />
        ...
        {/* Cement Card */}
       <div className="bg-white border rounded-xl shadow-md p-2 w-72 min-w-[270px] relative">
  <img src="/cement4.jpg" alt="Cement" className="w-full h-60 object-cover mb-4" />
  ...
  <button className="bg-orange-600 text-white py-2 px-4 rounded-full font-bold">
    ...
    VIEW PRODUCTS
        ...
        {/* Roofing Sheets Card */}
        <div className="bg-white border rounded-xl shadow-md p-2 w-72 min-w-[270px] relative">
          <img src="/roofing sheet1.png" alt="Roofing Sheets"  className="w-full h-60 object-cover mb-4"  />
